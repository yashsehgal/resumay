...
export default function DefaultScreenView() {
  return (
    <div className="default-screen-view w-[100vw] h-[100vh] flex flex-row items-center justify-center bg-gray-900">
      <div className="default-screen-content-wrapper w-[420px]">
        ...
        <p className="leading-snug text-gray-600 mt-3 flex flex-col items-start gap-1 mb-6">
          {"For creating a resume, add data in the configuration file,"}
          <span className="font-mono text-gray-300 px-2 py-1 bg-gray-700 rounded-md">{"src/config/resume-config.json"}</span>
        </p>
